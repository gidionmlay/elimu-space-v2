"""
User views for elimu_backend
Copy this content to users/views.py after creating the app
"""
...
class VerifyEmailView(APIView):
    ...
    def post(self, request):
        ...
        # 2. Sending email with verification link
        # 3. Verifying token and setting user.is_verified = True
