...
This is a template - copy this content to elimu_backend/settings.py after creating the project
"""
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': config('MONGODB_NAME', default='elimu_space_db'),
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(
        minutes=int(config('JWT_ACCESS_TOKEN_LIFETIME_MINUTES', default=60))
    ),
