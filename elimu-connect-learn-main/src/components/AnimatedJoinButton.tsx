    ...
    <div style={{
      ...
      <style>{`
        ...
        .bg::before {
          ...
          box-shadow:
            -7px 6px 0 0 rgb(217 119 6 / 40%),
            -14px 12px 0 0 rgb(217 119 6 / 30%),
            -21px 18px 4px 0 rgb(217 119 6 / 25%),
            -28px 24px 8px 0 rgb(217 119 6 / 15%),
            -35px 30px 12px 0 rgb(217 119 6 / 12%),
            -42px 36px 16px 0 rgb(217 119 6 / 8%),
            -56px 42px 20px 0 rgb(217 119 6 / 5%);
        }
        ...
        .content {
          ...
          box-shadow:
            inset -2px 12px 11px -5px var(--orange-200),
        ...
        .content::before {
          ...
          opacity: 0.7;
          margin: auto;
          background: linear-gradient(to bottom, transparent, var(--orange-400));
        ...
        .char span::after {
          ...
          position: absolute;
          color: var(--white);
          text-shadow: -1px 1px 2px var(--orange-500);
          left: 0;
        }
        .char span::before {
          opacity: 0;
        ...
        .icon div {
          position: relative;
          width: 24px;
          box-shadow: -2px 2px 5px var(--orange-400);
          transform: scale(0.9);
          background: linear-gradient(to bottom, var(--white), var(--orange-100));
        ...
        .icon div::before {
          ...
          top: 1px;
          box-shadow: 1px -2px 3px -1px var(--orange-400);
        ...
        .icon div::after {
          ...
          box-shadow: -2px 2px 3px 0 var(--orange-400);
          background: linear-gradient(200deg, var(--white), var(--orange-100));
        ...
        .button:active .bg::before {
          ...
          box-shadow:
            -7px 6px 0 0 rgb(217 119 6 / 40%),
            -14px 12px 0 0 rgb(217 119 6 / 25%),
            -21px 18px 4px 0 rgb(217 119 6 / 15%);
        }
        .button:active .content {
          box-shadow:
            inset -1px 12px 8px -5px rgba(217, 119, 6, 0.4),
            inset 0px -3px 8px 0px var(--orange-200);
        }
        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              ...
              <span data-label="n" style={{'--i': 2} as React.CSSProperties}>n</span>
              <span data-label="z" style={{'--i': 3} as React.CSSProperties}>z</span>
              <span data-label="a" style={{'--i': 4} as React.CSSProperties}>a</span>
              <span data-label="K" style={{'--i': 5} as React.CSSProperties}>K</span>
              <span data-label="u" style={{'--i': 6} as React.CSSProperties}>u</span>
              <span data-label="j" style={{'--i': 7} as React.CSSProperties}>j</span>
              <span data-label="i" style={{'--i': 8} as React.CSSProperties}>i</span>
              <span data-label="f" style={{'--i': 9} as React.CSSProperties}>f</span>
              <span data-label="u" style={{'--i': 10} as React.CSSProperties}>u</span>
              <span data-label="n" style={{'--i': 11} as React.CSSProperties}>n</span>
              <span data-label="z" style={{'--i': 12} as React.CSSProperties}>z</span>
              <span data-label="a" style={{'--i': 13} as React.CSSProperties}>a</span>
              <span data-label="L" style={{'--i': 14} as React.CSSProperties}>L</span>
              <span data-label="e" style={{'--i': 15} as React.CSSProperties}>e</span>
              <span data-label="o" style={{'--i': 16} as React.CSSProperties}>o</span>
            </span>
